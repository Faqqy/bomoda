...
<form role="form" data-toggle="validator" enctype="multipart/form-data" id="form-sobfeedback<?php echo $module_id; ?>">
    ...
    <div class="form_form_line">
        ...
        <input type="text" class="form-control" name="sob_input[<?php echo $field_row; ?>][<?php echo $field['name']?>]" id="sobInput[<?php echo $field_row; ?>]" data-minlength="3" required="" placeholder="<?php echo $field['name']; ?>">
        <div class="help-block with-errors"></div>
        <input type="hidden" class="form-control" name="sob_input[<?php echo $field_row; ?>][required]" id="sobInput[<?php echo $field_row; ?>]" value="input">
        <div class="form_rec">
            *
        </div>
    </div>
    ...
    <?php } else { ?>
        ...
        <input type="text"  name="sob_input[<?php echo $field_row; ?>][<?php echo $field['name']; ?>]" id="sobInput[<?php echo $field_row; ?>]" placeholder="<?php echo $field['name']; ?>">
    ...
    <div class="form-group required">
        ...
        <textarea class="form-control" name="sob_input[<?php echo $field_row; ?>][<?php echo $field['name']; ?>]" id="sobInputText" rows="3" data-minlength="5" required="" placeholder="<?php echo $field['name']; ?>"></textarea>
        <div class="help-block with-errors"></div>
        <input type="hidden" class="form-control" name="sob_input[<?php echo $field_row; ?>][required]" id="sobInputText[<?php echo $field_row; ?>]" value="textarea">
    </div>
    <?php } else { ?>
    <div class="form-group">
        <label for="sobInputText"><?php echo $field['name']; ?></label>
        <textarea class="form-control" name="sob_input[<?php echo $field_row; ?>][<?php echo $field['name']; ?>]" id="sobInputText" rows="3" placeholder="<?php echo $field['name']; ?>"></textarea>
    </div>
    <?php } ?>
    ...
    <div class="form-group required">
        ...
        <select class="form-control"  name="sob_input[<?php echo $field_row; ?>][<?php echo $field['name']; ?>]" id="sobInputSelect">
    ...
    <div class="form_form_line">
        ...
        <select data-placeholder="В ближайшее время" name="sob_input[<?php echo $field_row; ?>][<?php echo $field['name']; ?>]" id="sobInputSelect">
            <?php for ($i=0; $i < count($field['option']); $i++) { ?>
            <option><?php echo $field['option'][$i] ?></option>
            <?php } ?>
        </select>
    ...
    <div class="form-group required">
        ...
        <input type="hidden" class="form-control" name="sob_input[<?php echo $field_row; ?>][required]" id="sobInputRadio[<?php echo $field_row; ?>]" value="radio">
    </div>
    <?php } else { ?>
    <div class="form-group">
    ...
    <div class="form-group required">
        ...
        <div class="help-block with-errors"></div>
        <input type="hidden" class="form-control" name="sob_input[<?php echo $field_row; ?>][required]" id="sobInputCheckbox[<?php echo $field_row; ?>]" value="checkbox">
    </div>
    <?php } else { ?>
    <div class="form-group">
    ...
    <?php if ($field['required']) { ?>
    <div class="form-group required">
        <label class="control-label" for="sob_input<?php echo $field_row; ?>"><?php echo $field['name']; ?></label>
        <input type="text" class="form-control" name="sob_input[<?php echo $field_row; ?>][<?php echo $field['name']?>]" id="sobInput<?php echo $field_row; ?>" data-minlength="3" required="" placeholder="<?php echo $field['name']; ?>">
        <div class="help-block with-errors"></div>
        <input type="hidden" class="form-control" name="sob_input[<?php echo $field_row; ?>][required]" id="sobInput[<?php echo $field_row; ?>]" value="input">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" id="sobInput<?php echo $field_row; ?>" class="form-control" name="sob_input[<?php echo $field_row; ?>][<?php echo $field['name']; ?>]"  placeholder="<?php echo $field['name']; ?>">
    </div>
    <?php } ?>
    ...
    $('#form-sobfeedback<?php echo $module_id; ?>').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#feedbackModal .text-danger').remove();
                $('.call_form_text').html('');
                $('#call_form .call_form_title').html($('input[name="sob_input[1][Ваше имя]"]').val()+', ваша заявка принята! Мы свяжемся с вами в ближайшее время.');
                $('#call_form .form_form').html('');
...
<form role="form" data-toggle="validator" enctype="multipart/form-data" id="form-sobfeedback<?php echo $module_id; ?>">
    ...
    <div class="form-group">
        <label for="sob_input[<?php echo $field_row; ?>]"><?php echo $field['name']; ?></label>
        <input type="text" class="form-control" name="sob_input[<?php echo $field_row; ?>][<?php echo $field['name']; ?>]" id="sobInput[<?php echo $field_row; ?>]" placeholder="<?php echo $field['name']; ?>">
    </div>
    <?php } ?>
    <?php } elseif ($field['type'] == 'textarea' && $field['field_status']) { ?>
    <?php if ($field['required']) { ?>
