<?if($_GET['flag']=='pod') { ?>
  <?if($id=='edit_field25'||$id=='edit_field26') { ?>
<div class="form-group <?php if ($required) { ?>required<?php } ?> row-<?php echo $id ?>">


  <label class="" for="<?php echo $id ?>"><?php echo $label ?></label>
  <div class="">
...
?>
<div class="form-group <?php if ($required) { ?>required<?php } ?> row-<?php echo $id ?> <?=$class?>">

  <?if($id=='edit_field21') { ?>
    <label class="" for="<?php echo $id ?>">День рождения</label>
  <? } ?>
  <?if($id!='edit_field21'&&$id!='edit_field22'&&$id!='edit_field23') { ?>
    <label class="" for="<?php echo $id ?>"><?php echo $label ?></label>
  <? } ?>
...
<?if($id=='edit_field23') echo '<div class="clear"></div>';?>
<? } ?>
<? } ?>
