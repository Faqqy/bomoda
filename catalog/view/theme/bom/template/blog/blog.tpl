...
<div class="main_content m_row">
    <? include 'includes/leftmenuuser.php';?>
...
<? } elseif($parent_id==50) { //print_r($cats);?>
...
<div class="main_content m_row">
    <div class="main_title left_align hidden_mobile">
        <?php echo $heading_title; ?>
    </div>
    <div class="main_how">
        <div class="main_how_left">
            <div class="how_left_answer">
                <?if($article_id==28) { ?>
                    <p>
                        Введите номер вашего заказа и телефон, указанный при оформлении.<br/>
                        Номер заказа отправлялся вам в СМС при оформлении.

                    </p>
                    <div class="get_status_form">
                        <input type="text" name="get_status_number" placeholder="Номер заказа">
                        <input type="text" class="phone_input" name="get_status_phone" placeholder="Номер телефона">
                        <a class="get_status_btn">Проверить заказ</a>
                    </div>
                    <div class="get_status_form_error">
                    </div>
                    <div class="get_status_form_success">
                    </div>
