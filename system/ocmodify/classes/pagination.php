...
class OCMPagination {
  ...
  public function render() {
    ...
    return '<div class="col-sm-6 text-left" style="padding: 0px;">' . ($output ? '<ul class="' . $this->style_links . '">' . $output . '</ul>' : '') . '</div><div class="col-sm-6 text-right" style="padding: 0px;"><ul class="' . $this->style_results . '" style="margin: 10px 0px;">' . $results . '</ul></div>';
  }
}