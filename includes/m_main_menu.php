...
<div class="m_menu_bottom">
    ...
    <ul>
        ...
        <li <?if($_SERVER['REQUEST_URI']=='/address-book') echo 'class="active"'?>><a href="/address-book">Адрес доставки</a></li>
    ...
    <? } else { ?>
        <ul>
            ...
            <li><a href="/kontakty?menu=company">Контакты</a></li>
            <li><a href="/about_us?menu=company">О нас</a></li>
