...
class ControllerExtensionModulesocnetauth2 extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) 
		{
			...
			{
				$this->model_extension_module_socnetauth2->updateSetting('socnetauth2_popup_module', 
			...
			{
				$this->model_extension_module_socnetauth2->updateSetting('socnetauth2_popup', 
															'socnetauth2_popup_status', 
															0);
			}
			*/
			...
			if( !empty($this->request->post['stay']) )
			{
				...
				$this->response->redirect($this->url->link('extension/module/socnetauth2', 'token=' . $this->session->data['token'].'&tab='.$tab, true));
			}
			else
			{
		...
		$this->data['vkontakte_retargeting'] = $this->url->link('extension/module/socnetauth2/vkontakte_retargeting', 'token=' . $this->session->data['token'], true);
		$this->data['facebook_retargeting'] = $this->url->link('extension/module/socnetauth2/facebook_retargeting', 'token=' . $this->session->data['token'], true);
 		...
 		if (isset($this->error['warning'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/socnetauth2', 'token=' . $this->session->data['token'], true),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('extension/module/socnetauth2', 'token=' . $this->session->data['token'], true);
		
		$this->data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'], true);
