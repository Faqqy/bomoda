            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-bb" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="bb_payment_order_status_id" id="input-order-status" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="bb_payment_status" id="input-status" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="bb_payment_sort_order" value="<?php echo $bb_payment_sort_order; ?>" id="input-sort-order" class="form-control" />
                        </div>
                    </div>
                </form>
            </div>
